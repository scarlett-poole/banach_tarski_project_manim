...
# manim -pql Indep_Rotations.py 

class Indep_Rotations_1(ThreeDScene):
    # Parametric sphere
    def func(self, u, v):
    ...
    def construct(self):
        ...
        self.play(Rotate(surface, np.arccos(1/3), OUT),run_time=2) 
        self.play(Rotate(surface, -np.arccos(1/3), OUT),run_time=1)
        self.play(Rotate(surface, np.arccos(1/3), OUT),run_time=2) 
        self.play(Rotate(surface, -np.arccos(1/3), OUT),run_time=1)
        self.wait(1)
        ...
        self.play(Rotate(surface, np.arccos(1/3), RIGHT),run_time=2)
        self.play(Rotate(surface, -np.arccos(1/3), RIGHT),run_time=1)
        self.play(Rotate(surface, np.arccos(1/3), RIGHT),run_time=2)
        self.play(Rotate(surface, -np.arccos(1/3), RIGHT),run_time=1)
        self.wait(1)